...
function scan(state){
  if (state === 'poweredOn') {
    // noble.startScanning(['A495FF25-C5B1-4B44-B512-1370F02D74DE'],false);
    noble.startScanning(['A495FF20C5B14B44B5121370F02D74DE'],false);
    // noble.startScanning(['A495FF25C5B14B44B5121370F02D74DE'.toLowerCase()],false);
    // noble.startScanning();
